...
#include <stdio.h>
#include <stdlib.h>
#include "SRCArea_V4.cpp"
#include "SPEArea_V1.cpp"
using namespace std; 
...
void area_runs(){
    ...
    while (getline(file,str)){ //read file line by line
        ...
        if(type == "No"){
            ...
            try{
                outfile << SPEArea_V1(my_run, my_chanel)<<endl;
            ...
            //SOURCE FIT
            try{
                outfile << "\t" << SRCArea_V4(run_prior, chanel_prior, my_run, my_chanel)<<endl;
            ...
            //SOURCE FIT
            try{
                outfile<< "\t" << SRCArea_V4(run_priorto, chanel_priorto, my_run, my_chanel)<<endl;
