...
double myhist_ratio(TString SPE_run, TString SPE_ch, TString SRC_run, TString SRC_ch){
    ...
    src->Draw("area_3044_" +SPE_ch +">>file1(200,0,200000)", "width_3044_"+SPE_ch+">70", "");
    spe->Draw("area_3044_"+SRC_ch+">>file0(200,0,200000)", "width_3044_"+SRC_ch+">70", "");
    ...
    TString low_bound;
    low_bound.Form("%d", 200000/200*(low_bin));
    TString high_bound;
    high_bound.Form("%d", 200000/200*(high_bin));
    mod_spe->Draw("area_3044_"+SPE_ch+">>file2(25,"+low_bound+","+high_bound+")", "width_3044_"+SPE_ch+">70", "");
...
double SRCArea_V4(TString SPE_run, TString SPE_ch, TString SRC_run, TString SRC_ch){
